...
class TronCamera(val FieldofView: Float = 90f,val AspectRatio : Float = 16f/9f, val NearPlane: Float = 0.1f, val FarPlane: Float = 4000f, modelMatrix: Matrix4f = Matrix4f(), parent: Transformable? = null) : Transformable(modelMatrix, parent), ICamera{
